      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-[12px] font-semibold tracking-[0.12em] uppercase text-[#C41E3A]">About MEC India</p>
          </div>
          ...
          <Link href="/about" className="inline-flex mt-7 bg-[#C41E3A] hover:bg-[#A0182F] text-white px-6 py-3 rounded-md text-sm font-semibold transition">
            Know More →
          </Link>
        </div>
