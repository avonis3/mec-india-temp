      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-10 lg:mb-12">
          ...
          <p className="mt-3 text-[15px] sm:text-base text-[#6B7280] max-w-xl leading-7">
            From custom stall design to modular execution, MEC India delivers
            complete exhibition infrastructure with reliable on-ground support.
          </p>
        </div>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="p-7">
                ...
                <h3 className="text-xl font-bold leading-snug text-[#111111] mb-3">
                  {service.title}
                </h3>
                ...
                <Link
                  href={service.href}
                  className="inline-flex text-[13.5px] font-semibold text-[#C41E3A] transition-all group-hover:gap-2"
                >
                  Learn More →
                </Link>
              </div>
