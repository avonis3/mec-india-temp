      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          ...
          <h2 className="text-[30px] sm:text-[36px] lg:text-[46px] font-extrabold leading-[1.1] tracking-[-0.02em] text-[#111111]">
            Creating exhibition experiences that help brands stand out.
          </h2>

          <p className="mt-5 text-[15px] sm:text-base text-[#4B5563] leading-7">
            MEC India is an exhibition stall design and fabrication company
            offering complete solutions from concept, planning, production,
            installation, and on-site support.
          </p>

          <p className="mt-4 text-[15px] sm:text-base text-[#4B5563] leading-7">
            With years of experience across major exhibitions and venues, we
            help businesses create stalls that are functional, attractive, and
            built for real visitor engagement.
          </p>

          <Link
            href="/about"
            className="inline-flex mt-7 bg-[#C41E3A] hover:bg-[#A0182F] text-white px-6 py-3 rounded-md text-sm font-semibold transition"
          >
            Know More →
          </Link>
        </div>
