      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-[12px] font-semibold tracking-[0.12em] uppercase text-[#C41E3A]">Why Choose Us</p>
          </div>
          ...
          <p className="mt-4 text-[15px] sm:text-base text-[#4B5563] leading-7 max-w-xl">
            MEC India focuses on practical layouts, strong brand visibility, clean fabrication, and smooth project coordination from start to finish.
          </p>

          <div className="grid sm:grid-cols-2 gap-5 mt-10">
            {features.map(([title, desc]) => (
              <div key={title} className="bg-white border border-[#E5E7EB] rounded-lg p-6 hover:shadow-md transition">
                <div className="w-10 h-10 rounded-lg bg-red-50 mb-4" />
                <h3 className="text-[15px] font-bold text-[#111111] mb-2">{title}</h3>
        ...
        <div className="relative">
          <img src="/images/homepage/whychoose.png" alt="Why choose MEC India" className="w-full aspect-[4/3] object-cover rounded-[10px]" />
        </div>
      </div>
    </section>
  );
